...
The owner-facing authoring and session management is built. The participant-facing experience (guest access-code entry, live voting, real-time results) is the main in-progress work.
