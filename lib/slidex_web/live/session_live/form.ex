defmodule SlidexWeb.SessionLive.Form do
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              ...
              <p class="text-neutral text-xs border border-dashed border-base-300 bg-base-200 rounded p-3">
                You can generate an access code that will be required for participating in the voting process, regardless of whether the process is public or not.
              </p>
              <.button
  ...
  def handle_event("generate_code", _params, socket) do
    ...
    new_params =
      Map.put(current_params, "access_code", Slidex.Voting.AccessCode.generate())
  ...
  @impl true
  # Global "app:visitors" presence_diff (GlobalPresence subscription).
